...
public sealed record EncounterDist9 : EncounterStatic, ITeraRaid9
{
    ...
    protected override bool IsMatchPartial(PKM pk)
    {
        ...
        var param = new GenerateParam9(pk.Species,(byte)pi.Gender, FlawlessIVCount, 1, 0, 0, 0, Ability, Shiny);
    ...
    protected override void SetPINGA(PKM pk, EncounterCriteria criteria)
    {
        ...
        var pi = PersonalTable.SV.GetFormEntry(Species, Form);
        var param = new GenerateParam9(pk.Species,(byte)pi.Gender, FlawlessIVCount, rollCount,
