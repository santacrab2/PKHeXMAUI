...
public sealed record EncounterMight9 : EncounterStatic, ITeraRaid9
{
    ...
    protected override bool IsMatchPartial(PKM pk)
    {
        ...
        var param = new GenerateParam9(pk.Species,gender, FlawlessIVCount, 1, 0, 0, Scale, Ability, Shiny, Nature, IVs);
    ...
    protected override void SetPINGA(PKM pk, EncounterCriteria criteria)
    {
        ...
        byte gender = GetGender();
        var param = new GenerateParam9(pk9.Species,gender, FlawlessIVCount, rollCount,
